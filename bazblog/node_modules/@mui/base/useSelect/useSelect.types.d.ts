...
export type UseSelectButtonSlotProps<TOther = {}> =
    UseButtonRootSlotProps<Omit<TOther, keyof UseSelectButtonSlotEventHandlers>>
...
export type UseSelectHiddenInputSlotProps<TOther = {}> =
    UseSelectHiddenInputSlotEventHandlers
...
export type UseSelectListboxSlotProps<TOther = {}> =
    UseListRootSlotProps<Omit<TOther, keyof UseSelectListboxSlotEventHandlers>>

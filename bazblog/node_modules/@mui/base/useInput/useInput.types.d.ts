...
export type UseInputRootSlotProps<ExternalProps = {}> =
    Omit<ExternalProps, keyof UseInputRootSlotOwnProps | 'onBlur' | 'onChange' | 'onFocus'>
...
export type UseInputInputSlotProps<ExternalProps = {}> =
    Omit<ExternalProps, keyof UseInputInputSlotOwnProps>
